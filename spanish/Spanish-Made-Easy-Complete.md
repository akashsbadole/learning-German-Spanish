...
> **Level: A1 → A2 (CEFR)**
> Complete project brief: curriculum, lessons, grammar, vocabulary, dialogues, exercises, images, audio, flashcards, quizzes, workbook, teacher guide, review and formatting — all produced with AI, with explanations in **Marathi** and **Hindi**.
...
Use ChatGPT or another LLM to generate the curriculum.
...
Use AI image tools to create: family illustrations, classroom, restaurant, airport, city, shopping, weather, food, body parts.
...
Use AI text-to-speech. Generate: Spanish pronunciation, slow speed, normal speed, dialogue audio, listening practice.
...
## 7. Recommended AI Tools

| Tool | Use |
| --- | --- |
| **ChatGPT** | Curriculum design, lesson writing, explanations, exercises, quizzes, editing, formatting |
| **Claude** | Long-form drafting and consistency checks |
| **Google Gemini** | Alternative explanations and brainstorming |
| **DeepL** | Cross-check translations (Spanish ↔ Marathi ↔ Hindi ↔ English) |
| **ElevenLabs / Azure AI Speech** | High-quality Spanish pronunciation audio |
| **Canva** | Book layout, worksheets, printable flashcards |

---

## 8. Estimated Book Size
...
1. Generate lesson content (Phase 3 prompt)
2. Cross-check Spanish + translations with DeepL
3. Run Phase 14 AI review on the lesson
4. Add exercises, quiz, images and audio
5. Assemble into the book (Phase 15)

---

## 10. Numbers (Los Números)
...
## 11. Core Grammar (Gramática Básica)
...
## 12. Vocabulary Essentials (Vocabulario)
...
## 13. Sample Lesson — Greetings (Saludos)

> This is a **complete, ready-to-use model lesson**. Use it as the template for every other lesson (Phases 3–7). The same structure in `lesson-template.md` can be handed to any LLM to generate the next lesson.
...
## 14. Flashcards (Sample — Phase 10 template)
...
## 15. Sample Quiz (Phase 11 template)
...
## 16. Common Mistakes by Marathi/Hindi Speakers (Phase 13 preview)
...
## 17. Book Table of Contents (Phase 15 draft)
...
![Spanish Alphabet](images/alphabet.svg)
...
![Days and Months](images/days-calendar.svg)
...
![School Supplies](images/school-supplies.svg)
...
![Professions](images/professions.svg)
...
# Spanish Teacher's Guide — Marathi & Hindi Speakers (A1 + A2)
