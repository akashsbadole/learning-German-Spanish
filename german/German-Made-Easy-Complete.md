...
![German Alphabet](images/alphabet.svg)
...
![Colors](images/colors.svg)

### Die Wochentage und die Uhrzeit — Days, Time & Clock

![Days and Time](images/days-time.svg)
...
1. Theory (simple language, beginner-friendly)
2. German words — exactly 20:
   Columns: German | Pronunciation (Devanagari) | English | Hindi | Marathi
3. One daily conversation (6–8 lines) with:
   German | Pronunciation | English | Hindi | Marathi
4. Grammar notes for this chapter
5. 10 example sentences (German + English + Hindi + Marathi)
6. 10 exercises: fill blanks, matching, true/false, correct-the-error
7. 5 MCQ questions with answer marked ✔
8. 5 translation sentences (Hindi/Marathi → German)
9. Speaking practice (3 tasks)
10. Writing practice (1 task)
11. 10 memory tricks
12. Cultural tips about Germany

Rules:
- Pronunciation must use ONLY Devanagari script
- German must be 100% correct: umlauts (ä ö ü), ß, noun capitalisation
- Hindi and Marathi translations must be natural, not literal
- Add "Answer Key" for all exercises and MCQ
- Stay within Goethe A1/A2 syllabus
```
...
Chapter-{NN}-{topic}.md
├── 1. Theory
├── 2. Vocabulary (20 words) — German | Pronunciation | English | Hindi | Marathi
├── 3. Conversation — German | Pronunciation | English | Hindi | Marathi
├── 4. Grammar notes
├── 5. Example sentences (10)
...
├── 11. Memory tricks (10)
├── 12. Cultural tips
└── 13. Chapter Quiz (10 points) + Answer Key
```
...
## 4. Quality Checklist (run after every chapter)

- [ ] Umlauts correct: ä ö ü (never ae/oe/ue in book text)
- [ ] ß used correctly after long vowels; ss after short vowels
- [ ] ALL nouns capitalised (der Tisch, die Schule, das Buch)
- [ ] ch soft (ich = इख) vs hard (Nacht = नाख्ट) — never च
- [ ] ei = आइ, ie = ई, z = त्स, v = फ, w = व, sch = श
- [ ] Articles der/die/das shown with every noun (color-coded memory)
- [ ] du (तू) vs Sie (आप) used correctly
- [ ] Hindi is हिंदी, Marathi is मराठी — never mixed
- [ ] Pronunciation column uses only Devanagari
- [ ] 20 vocabulary words per chapter
- [ ] All exercises have an answer key
- [ ] Goethe A1/A2 level respected (no past tense in A1 chapters)
...
Check:
1. German grammar, umlauts, ß, noun capitalisation (must be error-free)
2. English meaning accuracy
3. Hindi translation naturalness
4. Marathi translation naturalness
5. Pronunciation accuracy (Devanagari)
6. Goethe A1/A2 compliance
7. Exercise answer-key correctness
8. Table consistency (column order)
9. No English needed as bridge language
...
| Item | Format | Example |
| --- | --- | --- |
| Chapter file | `Chapter-01-Begruessung.md` | — |
| Audio clip | `audio/ch01-vocab.mp3`, `audio/ch01-dialogue.mp3` | — |
| Image | `images/greetings.svg` | — |
| Flashcards | `flashcards/ch01.md` | — |
| Quiz | `quizzes/ch01-quiz.md` | — |


---

# Vocabulary Starter — 200+ Core German Words

> Starter dictionary for **German Made Easy** — German | Pronunciation | English | Hindi | Marathi | Example.
> Build on this to reach the Phase 5 target of 500 words (then 3,000).
> Pronunciation is in Devanagari only. Articles are included with every noun.

---

## 1. Greetings & Politeness (16)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| Hallo | हालो | Hello | नमस्ते | नमस्कार | Hallo, wie geht's? |
| Guten Morgen | गूटन मॉर्गन | Good morning | सुप्रभात | शुभ सकाळ | Guten Morgen, Herr Meier. |
| Guten Tag | गूटन टाग | Good day | नमस्ते | नमस्कार | Guten Tag, Frau Singh. |
| Guten Abend | गूटन आबेंट | Good evening | शुभ संध्या | शुभ संध्याकाळ | Guten Abend, Papa. |
| Gute Nacht | गूटे नाख्ट | Good night | शुभ रात्रि | शुभ रात्री | Gute Nacht, Kinder! |
| Danke | डांके | Thank you | धन्यवाद | धन्यवाद | Danke für alles. |
| Bitte | बिटे | Please | कृपया | कृपया | Ein Kaffee, bitte. |
| Entschuldigung | एंटशुल्डीगुंग | Excuse me | माफ़ कीजिए | माफ करा | Entschuldigung, wo ist der Bahnhof? |
| Tschüss | त्स्युस | Bye | अलविदा | निरोप | Tschüss, bis morgen! |
| Auf Wiedersehen | आउफ वीडेर्ज़ेन | Goodbye | अलविदा | निरोप | Auf Wiedersehen, Frau Doktor. |
| Ja | या | Yes | हाँ | होय | Ja, ich komme. |
| Nein | नाइन | No | नहीं | नाही | Nein, danke. |
| Wie geht's? | वी गेट्स? | How are you? | आप कैसे हैं? | कसे आहेस? | Hallo! Wie geht's? |
| Mir geht es gut | मीर गेट एस गूट | I'm fine | मैं ठीक हूँ | मी ठीक आहे | Mir geht es gut, danke. |
| Willkommen | विल्कोमेन | Welcome | स्वागत है | स्वागत | Willkommen in Deutschland! |
| Alles Gute | आलेस गूटे | All the best | शुभकामनाएँ | शुभेच्छा | Alles Gute zum Geburtstag! |

## 2. Numbers (12)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| eins | आइन्स | one | एक | एक | Ich habe einen Bruder. |
| zwei | त्स्वाइ | two | दो | दोन | Zwei Kaffee, bitte. |
| drei | द्राइ | three | तीन | तीन | Drei Bücher. |
| vier | फीर | four | चार | चार | Vier Stunden. |
| fünf | फुन्फ | five | पाँच | पाच | Fünf Minuten. |
| sechs | ज़ेक्स | six | छह | सहा | Um sechs Uhr. |
| sieben | ज़ीबेन | seven | सात | सात | Sieben Tage. |
| acht | आख्ट | eight | आठ | आठ | Acht Euro. |
| neun | नोइन | nine | नौ | नऊ | Neun Kinder. |
| zehn | त्सेन | ten | दस | दहा | Zehn Finger. |
| hundert | हुंडर्ट | hundred | सौ | शंभर | Hundert Euro. |
| erste | एर्स्टे | first | पहला | पहिला | Der erste Tag. |

## 3. Colors (11)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| rot | रोट | red | लाल | लाल | Ein rotes Auto. |
| blau | ब्लाऊ | blue | नीला | निळा | Der Himmel ist blau. |
| grün | ग्रून | green | हरा | हिरवा | Das Gras ist grün. |
| gelb | गेल्प | yellow | पीला | पिवळा | Die Sonne ist gelb. |
| orange | ओरांशे | orange | नारंगी | केशरी | Eine orange Blume. |
| rosa | रोज़ा | pink | गुलाबी | गुलाबी | Ein rosa Kleid. |
| schwarz | श्वार्ट्स | black | काला | काळा | Eine schwarze Katze. |
| weiß | वाइस | white | सफ़ेद | पांढरा | Weißes Papier. |
| grau | ग्राऊ | grey | स्लेटी | राखाडी | Ein grauer Tag. |
| braun | ब्राऊन | brown | भूरा | तपकिरी | Braune Schuhe. |
| lila | लीला | purple | बैंगनी | जांभळा | Eine lila Tasche. |

## 4. Days & Months (19)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| Montag | मोंटाग | Monday | सोमवार | सोमवार | Am Montag arbeite ich. |
| Dienstag | डीन्स्टाग | Tuesday | मंगलवार | मंगळवार | Am Dienstag lernen wir. |
| Mittwoch | मिट्वोख | Wednesday | बुधवार | बुधवार | Am Mittwoch regnet es. |
| Donnerstag | डॉनर्स्टाग | Thursday | गुरुवार | गुरुवार | Am Donnerstag ist Kurs. |
| Freitag | फ्राइटाग | Friday | शुक्रवार | शुक्रवार | Am Freitag ruhe ich. |
| Samstag | ज़ाम्स्टाग | Saturday | शनिवार | शनिवार | Am Samstag gehen wir aus. |
| Sonntag | ज़ोंटाग | Sunday | रविवार | रविवार | Am Sonntag schlafe ich. |
| Januar | यानुआर | January | जनवरी | जानेवारी | Januar ist kalt. |
| Februar | फेब्रुआर | February | फ़रवरी | फेब्रुवारी | Februar hat 28 Tage. |
| März | मेर्स | March | मार्च | मार्च | März ist Frühling. |
| April | अप्रिल | April | अप्रैल | एप्रिल | Im April regnet es. |
| Mai | माई | May | मई | मे | Der Mai ist schön. |
| Juni | यूनी | June | जून | जून | Der Juni ist warm. |
| Juli | यूली | July | जुलाई | जुलै | Der Juli ist Sommer. |
| August | आउगुस्ट | August | अगस्त | ऑगस्ट | Der August ist heiß. |
| September | सेप्टेम्बर | September | सितंबर | सप्टेंबर | Im September beginnt die Schule. |
| Oktober | ओक्टोबर | October | अक्टूबर | ऑक्टोबर | Der Oktober ist Herbst. |
| November | नोवेम्बर | November | नवंबर | नोव्हेंबर | Der November ist kühl. |
| Dezember | देज़ेम्बर | December | दिसंबर | डिसेंबर | Der Dezember ist Weihnachten. |

## 5. Family (14)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| die Mutter | मुटर | mother | माँ | आई | Meine Mutter kocht gut. |
| der Vater | फाटर | father | पिता | वडील | Mein Vater ist Arzt. |
| der Bruder | ब्रूडर | brother | भाई | भाऊ | Ich habe einen Bruder. |
| die Schwester | श्वेस्टर | sister | बहन | बहीण | Meine Schwester ist klein. |
| der Sohn | ज़ोन | son | बेटा | मुलगा | Mein Sohn lernt Deutsch. |
| die Tochter | टोख्टर | daughter | बेटी | मुलगी | Meine Tochter singt. |
| der Großvater | ग्रोस्फाटर | grandfather | दादा/नाना | आजोबा | Mein Großvater ist alt. |
| die Großmutter | ग्रोस्मुटर | grandmother | दादी/नानी | आजी | Meine Großmutter ist lieb. |
| der Onkel | ओन्केल | uncle | चाचा/मामा | काका/मामा | Mein Onkel lebt in Mumbai. |
| die Tante | टांटे | aunt | चाची/मामी | काकू/मावशी | Meine Tante ist Lehrerin. |
| der Cousin | कुज़िन | cousin (m) | चचेरा भाई | चुलत भाऊ | Mein Cousin ist mein Freund. |
| die Cousine | कुज़िने | cousin (f) | चचेरी बहन | चुलत बहीण | Meine Cousine singt gut. |
| der Ehemann | एहेमान | husband | पति | नवरा | Mein Ehemann arbeitet viel. |
| die Ehefrau | एहेफ्राऊ | wife | पत्नी | बायको | Meine Ehefrau ist Ärztin. |

## 6. Food (20)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| das Brot | ब्रोट | bread | ब्रेड/रोटी | पाव | Das Brot ist frisch. |
| der Reis | राइस | rice | चावल | तांदूळ | Ich esse gerne Reis. |
| das Fleisch | फ्लाइश | meat | मांस | मांस | Ich esse Fleisch am Sonntag. |
| der Fisch | फिश | fish | मछली | मासा | Der Fisch ist gesund. |
| das Huhn | हून | chicken | मुर्गा | कोंबडी | Das Huhn ist lecker. |
| das Ei | आइ | egg | अंडा | अंडे | Ich frühstücke mit Ei. |
| die Milch | मिल्ख | milk | दूध | दूध | Ich trinke warme Milch. |
| der Käse | केज़े | cheese | चीज़/पनीर | चीज | Der Käse ist stark. |
| das Wasser | वासर | water | पानी | पाणी | Ich möchte kaltes Wasser. |
| der Tee | ते | tea | चाय | चहा | Ich trinke Tee am Abend. |
| der Kaffee | काफे | coffee | कॉफ़ी | कॉफी | Der Kaffee ist bitter. |
| der Apfel | आप्फेल | apple | सेब | सफरचंद | Ein Apfel am Tag. |
| die Banane | बानाने | banana | केला | केळे | Die Banane ist süß. |
| die Orange | ओरांशे | orange (fruit) | संतरा | संत्रे | Die Orange ist saftig. |
| die Tomate | तोमाते | tomato | टमाटर | टोमॅटो | Die Tomate ist rot. |
| die Suppe | ज़ुपे | soup | सूप | सूप | Die Suppe ist heiß. |
| der Zucker | त्सुकर | sugar | चीनी | साखर | Der Tee hat Zucker. |
| das Salz | ज़ाल्ट्स | salt | नमक | मीठ | Die Suppe hat wenig Salz. |
| das Obst | ओब्स्ट | fruit | फल | फळ | Obst ist gesund. |
| das Gemüse | गेम्यूज़े | vegetables | सब्ज़ी | भाजी | Ich esse Gemüse jeden Tag. |

## 7. Drinks (8)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| das Wasser | वासर | water | पानी | पाणी | Wasser, bitte. |
| die Milch | मिल्ख | milk | दूध | दूध | Milch mit Schokolade. |
| der Kaffee | काफे | coffee | कॉफ़ी | कॉफी | Ein Kaffee, bitte. |
| der Tee | ते | tea | चाय | चहा | Tee mit Zitrone. |
| der Saft | ज़ाफ्ट | juice | जूस | रस | Ein Glas Saft. |
| das Bier | बीर | beer | बियर | बिअर | Ein kaltes Bier. |
| der Wein | वाइन | wine | शराब | द्राक्षारस | Rotwein, bitte. |
| die Limonade | लिमोनादे | lemonade | कोल्ड ड्रिंक | शीतपेय | Eine Limonade, bitte. |

## 8. House (16)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| das Haus | हाऊस | house | घर | घर | Mein Haus ist groß. |
| die Küche | क्युखे | kitchen | रसोई | स्वयंपाकघर | Die Küche ist sauber. |
| das Schlafzimmer | श्लाफ्त्सिमर | bedroom | शयनकक्ष | बेडरूम | Das Schlafzimmer ist blau. |
| das Bad | बात | bathroom | बाथरूम | स्नानगृह | Das Bad ist besetzt. |
| das Wohnzimmer | वोन्त्सिमर | living room | बैठक कक्ष | दिवाणखाना | Das Wohnzimmer ist gemütlich. |
| die Tür | त्युर | door | दरवाज़ा | दरवाजा | Die Tür ist offen. |
| das Fenster | फेन्स्टर | window | खिड़की | खिडकी | Das Fenster ist groß. |
| der Tisch | तिश | table | मेज़ | टेबल | Der Tisch ist aus Holz. |
| der Stuhl | श्तूल | chair | कुर्सी | खुर्ची | Ein roter Stuhl. |
| das Bett | बेट | bed | बिस्तर | अंथरूण | Das Bett ist weich. |
| das Sofa | ज़ोफा | sofa | सोफ़ा | सोफा | Das Sofa ist neu. |
| der Kühlschrank | क्युल्श्रान्क | fridge | फ़्रिज | फ्रीज | Der Kühlschrank ist voll. |
| die Lampe | लाम्पे | lamp | लैंप | दिवा | Die Lampe ist an. |
| der Spiegel | श्पीगेल | mirror | आईना | आरसा | Der Spiegel ist kaputt. |
| die Treppe | त्रेपे | stairs | सीढ़ियाँ | पायऱ्या | Die Treppe ist hoch. |
| der Garten | गार्टेन | garden | बगीचा | बाग | Der Garten hat Blumen. |

## 9. School (14)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| die Schule | शूले | school | स्कूल | शाळा | Die Schule ist nah. |
| die Klasse | क्लासे | class | कक्षा | वर्ग | Die Klasse beginnt um 9. |
| der Lehrer | लेरर | teacher (m) | शिक्षक | शिक्षक | Der Lehrer erklärt gut. |
| die Lehrerin | लेररिन | teacher (f) | शिक्षिका | शिक्षिका | Die Lehrerin ist nett. |
| der Student | श्तुदेन्ट | student | छात्र | विद्यार्थी | Der Student fragt. |
| das Buch | बूख | book | किताब | पुस्तक | Das Buch ist interessant. |
| das Heft | हेफ्ट | notebook | कॉपी | वही | Mein Heft ist blau. |
| der Bleistift | ब्लाइश्तिफ्ट | pencil | पेंसिल | पेन्सिल | Ein gelber Bleistift. |
| der Kugelschreiber | कुगेल्श्राइबर | pen | कलम/पेन | पेन | Der Kugelschreiber ist rot. |
| der Rucksack | रुक्ज़ाक | backpack | बस्ता | दप्तर | Der Rucksack ist schwer. |
| die Tafel | ताफेल | blackboard | ब्लैकबोर्ड | फळा | Die Tafel ist grün. |
| die Hausaufgabe | हाऊस्आउफगाबे | homework | होमवर्क | गृहपाठ | Die Hausaufgabe ist schwer. |
| die Prüfung | प्र्युफुंग | exam | परीक्षा | परीक्षा | Die Prüfung ist leicht. |
| der Schüler | श्युलर | pupil | विद्यार्थी | विद्यार्थी | Es gibt zwanzig Schüler. |

## 10. Clothes (10)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| das Hemd | हेम्ट | shirt | कमीज़ | शर्ट | Das Hemd ist weiß. |
| die Hose | होज़े | trousers | पैंट | पँट | Die Hose ist schwarz. |
| das Kleid | क्लाइट | dress | पोशाक | पोशाख | Das Kleid ist schön. |
| der Rock | रोक | skirt | स्कर्ट | स्कर्ट | Der Rock ist kurz. |
| die Schuhe | शूहे | shoes | जूते | शूज | Die Schuhe sind bequem. |
| der Hut | हूट | hat | टोपी | टोपी | Der Hut ist alt. |
| die Jacke | याके | jacket | जैकेट | जॅकेट | Die Jacke ist warm. |
| die Socken | ज़ोकेन | socks | मोज़े | मोजे | Die Socken sind weiß. |
| der Mantel | मान्टेल | coat | कोट | कोट | Der Mantel ist lang. |
| der Schal | शाल | scarf | दुपट्टा | स्कार्फ | Der Schal ist aus Wolle. |

## 11. Transport (12)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| das Auto | आउतो | car | कार | गाडी | Das Auto ist schnell. |
| der Bus | बुस | bus | बस | बस | Der Bus kommt spät. |
| der Zug | त्सुग | train | रेलगाड़ी | रेल्वे | Der Zug fährt um 8. |
| das Flugzeug | फ्लुग्त्सोइक | plane | हवाई जहाज़ | विमान | Das Flugzeug fliegt hoch. |
| das Schiff | शिफ | ship | जहाज़ | जहाज | Das Schiff ist groß. |
| das Fahrrad | फार्रात | bicycle | साइकिल | सायकल | Das Fahrrad ist neu. |
| das Motorrad | मोतोर्रात | motorbike | मोटरसाइकिल | मोटरसायकल | Das Motorrad ist laut. |
| das Taxi | ताक्सी | taxi | टैक्सी | टॅक्सी | Ein Taxi zum Flughafen. |
| die U-Bahn | ऊ-बान | metro | मेट्रो | मेट्रो | Die U-Bahn ist schnell. |
| die Haltestelle | हाल्टेश्तेले | stop | स्टॉप | स्टॉप | Die Haltestelle ist nah. |
| der Bahnhof | बान्होफ | station | स्टेशन | स्थानक | Der Bahnhof ist alt. |
| die Fahrkarte | फार्कार्टे | ticket | टिकट | तिकीट | Eine Fahrkarte nach Berlin. |

## 12. Body (14)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| der Kopf | कोप्फ | head | सिर | डोके | Mir tut der Kopf weh. |
| das Auge | आउगे | eye | आँख | डोळा | Ich habe schwarze Augen. |
| die Nase | नाज़े | nose | नाक | नाक | Die Nase ist klein. |
| der Mund | मुंट | mouth | मुँह | तोंड | Öffne den Mund. |
| das Ohr | ओर | ear | कान | कान | Mein Ohr tut weh. |
| die Hand | हान्ट | hand | हाथ | हात | Gib mir die Hand. |
| der Arm | आर्म | arm | बाज़ू | हात | Der Arm ist stark. |
| das Bein | बाइन | leg | टाँग | पाय | Mein Bein tut weh. |
| der Fuß | फूस | foot | पैर | पाय | Der Fuß ist kalt. |
| der Finger | फिंगर | finger | उंगली | बोट | Fünf Finger an der Hand. |
| der Bauch | बाऊख | stomach | पेट | पोट | Mein Bauch tut weh. |
| das Herz | हेर्त्स | heart | दिल | हृदय | Das Herz schlägt schnell. |
| das Haar | हार | hair | बाल | केस | Das Haar ist schwarz. |
| der Rücken | र्युकेन | back | पीठ | पाठ | Mein Rücken tut weh. |

## 13. Nature (14)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| die Sonne | ज़ोने | sun | सूरज | सूर्य | Die Sonne scheint. |
| der Mond | मोंट | moon | चाँद | चंद्र | Der Mond ist weiß. |
| der Himmel | हिमेल | sky | आसमान | आकाश | Der Himmel ist blau. |
| der Regen | रेगेन | rain | बारिश | पाऊस | Der Regen ist stark. |
| der Schnee | श्ने | snow | बर्फ | बर्फ | Der Schnee ist weiß. |
| der Wind | विन्ट | wind | हवा | वारा | Der Wind ist kalt. |
| der Baum | बाऊम | tree | पेड़ | झाड | Der Baum ist hoch. |
| die Blume | ब्लूमे | flower | फूल | फूल | Die Blume ist rot. |
| der Fluss | फ्लुस | river | नदी | नदी | Der Fluss ist lang. |
| das Meer | मेर | sea | समुद्र | समुद्र | Das Meer ist blau. |
| der Berg | बेर्ख | mountain | पहाड़ | पर्वत | Der Berg ist hoch. |
| die Erde | एर्दे | earth | धरती | जमीन | Die Erde ist trocken. |
| das Feuer | फोयर | fire | आग | आग | Das Feuer ist heiß. |
| das Tier | तीर | animal | जानवर | प्राणी | Das Tier ist wild. |

## 14. Time (10)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| die Zeit | त्साइट | time | समय | वेळ | Ich habe keine Zeit. |
| die Stunde | श्तुंदे | hour | घंटा | तास | Eine Stunde, bitte. |
| die Minute | मिनूते | minute | मिनट | मिनिट | Fünf Minuten. |
| der Tag | टाग | day | दिन | दिवस | Ein schöner Tag. |
| die Nacht | नाख्ट | night | रात | रात्र | Die Nacht ist ruhig. |
| die Woche | वोखे | week | हफ़्ता | आठवडा | Die Woche ist lang. |
| der Monat | मोनात | month | महीना | महिना | Der Monat ist kurz. |
| das Jahr | यार | year | साल | वर्ष | Frohes neues Jahr! |
| heute | हॉइटे | today | आज | आज | Heute ist Montag. |
| morgen | मॉर्गन | tomorrow | कल | उद्या | Morgen gehe ich zur Schule. |

## 15. Common Verbs (16)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| sein | ज़ाइन | to be | होना | असणे | Ich bin aus Indien. |
| haben | हाबेन | to have | रखना | असणे (कडे) | Ich habe zwei Brüder. |
| gehen | गेएन | to go | जाना | जाणे | Ich gehe zur Schule. |
| kommen | कोमेन | to come | आना | येणे | Ich komme aus der Arbeit. |
| sprechen | श्प्रेखेन | to speak | बोलना | बोलणे | Ich spreche etwas Deutsch. |
| essen | एसेन | to eat | खाना | खाणे | Ich esse um 2 Uhr. |
| trinken | त्रिन्केन | to drink | पीना | पिणे | Ich trinke Wasser. |
| wohnen | वोनेन | to live | रहना | राहणे | Ich wohne in Mumbai. |
| arbeiten | आर्बाइटेन | to work | काम करना | काम करणे | Ich arbeite im Büro. |
| lernen | लेर्नेन | to learn | सीखना | शिकणे | Ich lerne Deutsch. |
| schauen | शाऊएन | to look/watch | देखना | पाहणे | Ich schaue fern. |
| hören | ह्यूरेन | to hear | सुनना | ऐकणे | Ich höre Musik. |
| laufen | लाऊफेन | to run/walk | चलना | चालणे | Ich laufe zum Park. |
| kaufen | काऊफेन | to buy | खरीदना | विकत घेणे | Ich kaufe Brot. |
| wollen | वोलेन | to want | चाहना | इच्छा असणे | Ich will einen Kaffee. |
| können | क्योनेन | can | सकना | शकणे | Ich kann Deutsch sprechen. |

## 16. Common Adjectives (14)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| groß | ग्रोस | big | बड़ा | मोठा | Ein großes Haus. |
| klein | क्लाइन | small | छोटा | लहान | Ein kleiner Hund. |
| gut | गूट | good | अच्छा | चांगला | Ein guter Freund. |
| schlecht | श्लेख्ट | bad | बुरा | वाईट | Schlechtes Wetter. |
| neu | नोइ | new | नया | नवीन | Ein neues Auto. |
| alt | आल्ट | old | पुराना | जुना | Ein altes Buch. |
| hoch | होख | tall | लंबा/ऊँचा | उंच | Ein hoher Berg. |
| niedrig | नीद्रिख | low | नीचा | बुटका | Ein niedriger Tisch. |
| kalt | काल्ट | cold | ठंडा | थंड | Kaltes Wasser. |
| heiß | हाइस | hot | गर्म | गरम | Heißer Tee. |
| leicht | लाइख्ट | easy/light | आसान/हल्का | सोपे/हलके | Die Prüfung ist leicht. |
...
# German Teacher's Guide — Marathi & Hindi Speakers (A1 + A2)

> Written by a German teacher who also speaks Marathi (मराठी) and Hindi (हिंदी).
> Two complete courses: **Course 1 = A1 (12 weeks)** and **Course 2 = A2 (12 weeks)** — grammar, vocabulary, skills and exam preparation for both Goethe levels.
>
> Related files: [Exam Guide](goethe-exam-guide.md) · [Mock Test A1](mock-test-a1.md) · [Mock Test A2](mock-test-a2.md)

---

## Part 0 — The Teacher's Diagnosis: What Marathi/Hindi Speakers Already Know

Indian students are NOT beginners in grammar — they bring powerful tools:

| Advantage | Hindi | Marathi | German | How to use it |
| --- | --- | --- | --- | --- |
| **Cases (कारक)** | कर्म कारक, करण कारक | दाता कारक, अपादान कारक | 4 cases: Nominativ, Akkusativ, Dativ, Genitiv | Teach **Dativ = दाता कारक** — the concept already exists! |
| **SOV word order** | मैं जानता हूँ कि वह किताब पढ़ता है | मला वाटते की तो पुस्तक वाचतो | Ich weiß, **dass er das Buch liest** | German subordinate clauses have the same structure — teach them EARLY |
| **Formal/informal** | आप / तुम / तू | तुम्ही / तू | Sie / du | Perfect 1:1 match. Explain once, never explain again |
| **Gender** | पुल्लिंग / स्त्रीलिंग | पुल्लिंग / स्त्रीलिंग / नपुंसकलिंग | der / die / das | Concept known; but German gender is NOT logical — memorize noun + article TOGETHER |
| **Compound words** | राजधानी (state+capital) | सरकारीकार्यालय | Handschuh (hand+shoe), Krankenhaus | Compounds feel natural — teach them proudly |
| **Verb endings** | मैं जाता हूँ / तू जाता है | मी जातो / तू जातोस | ich gehe / du gehst | Verb conjugation exists in their languages — only the forms are new |
| **Prepositions + cases** | मेज के ऊपर | टेबलवर | auf dem Tisch | Postposition ↔ preposition is a small mental shift |

> **Teacher's golden rule:** Teach German **through Hindi/Marathi grammar**, not through English grammar. English is the only language of these four that has no cases and no gender — it makes everything harder.

---

# Course 1 — GERMAN A1 (12 Weeks)

## 1A. A1 Syllabus — Week by Week

| Week | Topic | Grammar | Vocabulary | Exam link |
| --- | --- | --- | --- | --- |
| 1 | Alphabet & sounds (30 letters + Ä Ö Ü ß) | Spelling your name | Greetings: Hallo, Guten Morgen, Tschüss | Hören 4B: spell name |
| 2 | Numbers 0–20 | — | Phone numbers, prices | Hören Part 1: numbers |
| 3 | sein + haben | ich bin / du bist…, ich habe… | Family: die Mutter, der Vater | Sprechen: introduce yourself |
| 4 | Regular verbs (kommen, wohnen, heißen) | **Verb = 2nd position** | Countries, cities, languages | Lesen Part 2: short messages |
| 5 | Numbers to 100, dates, time | Uhrzeit: es ist… Uhr | Days, months, seasons | Hören Part 1: times |
| 6 | **der/die/das** | Articles + noun gender | House & furniture | Lesen Part 4: form |
| 7 | Possessives mein/dein | mein Vater, dein Buch | School & work | Schreiben Part 1: form |
| 8 | **Nominativ → Akkusativ** | den, einen; mich, dich | Food & drinks | Lesen Part 3: ads |
| 9 | Modal: können, möchten | Ich möchte…, Können Sie…? | Restaurant, shopping | Sprechen Part 3: requests |
| 10 | **Dativ (दाता कारक!)** | dem, einem; mir, dir; helfen, danken | Transport & travel | Lesen Part 5: matching |
| 11 | Prepositions (in, auf, mit, nach) + **SOV subordinate (dass, weil)** | weil ich müde bin | Weather, free time | Schreiben Part 2: message |
| 12 | **Full A1 mock test** | Revision of all | All A1 topics | [Mock Test A1](mock-test-a1.md) |

## 1B. A1 Vocabulary — Top 100 Frequency Words (learn FIRST — they are 50% of speech)

| # | German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | ich | इष | I | मैं | मी | Ich bin Riya. |
| 2 | du | दू | you (informal) | तुम | तू | Du bist mein Freund. |
| 3 | Sie | ज़ी | you (formal) | आप | तुम्ही | Wie heißen Sie? |
| 4 | wir | वीर | we | हम | आम्ही | Wir kommen aus Indien. |
| 5 | sie | ज़ी | she/they | वह/वे | ती/ते | Sie heißt Anna. |
| 6 | er | एर | he | वह | तो | Er ist mein Bruder. |
| 7 | das | दास | the/that (neut.) | यह/वह | हे/ते | Das ist ein Buch. |
| 8 | der | देर | the (masc.) | — | — | der Tisch |
| 9 | die | डी | the (fem./pl.) | — | — | die Lampe |
| 10 | ein | आइन | a | एक | एक | ein Auto |
| 11 | und | उंत | and | और | आणि | Brot und Käse |
| 12 | oder | ओडर | or | या | किंवा | Tee oder Kaffee? |
| 13 | aber | आबर | but | लेकिन | पण | Ich komme, aber später. |
| 14 | nicht | निष्ट | not | नहीं | नाही | Ich bin nicht müde. |
| 15 | ja | या | yes | हाँ | हो | Ja, gern. |
| 16 | nein | नाइन | no | नहीं | नाही | Nein, danke. |
| 17 | bitte | बिटे | please | कृपया | कृपया | Bitte schön. |
| 18 | danke | डांके | thanks | धन्यवाद | धन्यवाद | Danke sehr! |
| 19 | ich bin | इष बिन | I am | मैं हूँ | मी आहे | Ich bin Lehrer. |
| 20 | ich habe | इष हाबे | I have | मेरे पास है | माझ्याकडे आहे | Ich habe Hunger. |
| 21 | du bist | दू बिस्ट | you are | तुम हो | तू आहेस | Du bist nett. |
| 22 | er/sie ist | एर/ज़ी इस्त | he/she is | वह है | तो/ती आहे | Sie ist Ärztin. |
| 23 | wir sind | वीर ज़िंट | we are | हम हैं | आम्ही आहोत | Wir sind glücklich. |
| 24 | ich habe nicht | — | I don't have | मेरे पास नहीं | माझ्याकडे नाही | Ich habe kein Geld. |
| 25 | haben | हाबेन | to have | होना (पास) | कडे असणे | Hast du Zeit? |
| 26 | sein | ज़ाइन | to be | होना | असणे | Das ist gut. |
| 27 | werden | वेर्डेन | to become | बनना | होणे | Ich werde Arzt. |
| 28 | können | क्योनेन | can | सकना | शकणे | Ich kann schwimmen. |
| 29 | möchten | मोष्टेन | would like | चाहना | हवे असणे | Ich möchte Tee. |
| 30 | müssen | म्युसेन | must | करना पड़ता है | लागणे | Ich muss arbeiten. |
| 31 | wollen | वोलेन | want to | चाहना | पाहिजे | Wir wollen essen. |
| 32 | gehen | गेहेन | to go | जाना | जाणे | Ich gehe nach Hause. |
| 33 | kommen | कोमेन | to come | आना | येणे | Kommst du mit? |
| 34 | machen | माख़ेन | to do/make | करना | करणे | Was machst du? |
| 35 | sagen | ज़ागेन | to say | कहना | म्हणणे | Ich sage die Wahrheit. |
| 36 | sehen | ज़ेहेन | to see | देखना | पाहणे | Ich sehe ein Haus. |
| 37 | essen | एसेन | to eat | खाना | खाणे | Ich esse Reis. |
| 38 | trinken | त्रिंकेन | to drink | पीना | पिणे | Ich trinke Wasser. |
| 39 | nehmen | नेमेन | to take | लेना | घेणे | Ich nehme den Bus. |
| 40 | geben | गेबेन | to give | देना | देणे | Gib mir das Buch! |
| 41 | finden | फ़िंडेन | to find | ढूँढना | शोधणे | Ich finde den Schlüssel. |
| 42 | wohnen | वोनेन | to live | रहना | राहणे | Ich wohne in Pune. |
| 43 | heißen | हाइसेन | to be called | नाम होना | नाव असणे | Ich heiße Riya. |
| 44 | wissen | विसेन | to know (facts) | जानना | माहीत असणे | Ich weiß das nicht. |
| 45 | kennen | केनेन | to know (people) | जानना | ओळखणे | Ich kenne Anna. |
| 46 | verstehen | फ़ेरश्टेहेन | to understand | समझना | समजणे | Ich verstehe nicht. |
| 47 | sprechen | श्प्रेख़ेन | to speak | बोलना | बोलणे | Ich spreche Hindi. |
| 48 | heißen | — | to be named | — | — | Wie heißt du? |
| 49 | gern | गेर्न | gladly | खुशी से | आवडीने | Ich trinke gern Tee. |
| 50 | heute | हॉयटे | today | आज | आज | Heute ist Montag. |
| 51 | morgen | मोर्गेन | tomorrow | कल (आगे) | उद्या | Morgen gehe ich zur Arbeit. |
| 52 | gestern | गेस्टर्न | yesterday | कल (पीछे) | काल | Gestern war ich krank. |
| 53 | jetzt | येत्स्ट | now | अभी | आता | Ich esse jetzt. |
| 54 | hier | हीर | here | यहाँ | इथे | Das Buch ist hier. |
| 55 | dort | दोर्ट | there | वहाँ | तिथे | Der Bahnhof ist dort. |
| 56 | wo | वो | where | कहाँ | कुठे | Wo wohnst du? |
| 57 | wann | वान | when | कब | केव्हा | Wann kommst du? |
| 58 | was | वास | what | क्या | काय | Was ist das? |
| 59 | wer | वेर | who | कौन | कोण | Wer ist das? |
| 60 | wie | वी | how | कैसे | कसे | Wie geht es dir? |
| 61 | warum | वारुम | why | क्यों | का | Warum lernst du Deutsch? |
| 62 | auch | आउख़ | also | भी | सुद्धा | Ich auch. |
| 63 | sehr | ज़ेर | very | बहुत | खूप | Das ist sehr gut. |
| 64 | viel | फ़ील | much/many | बहुत | भरपूर | Vielen Dank! |
| 65 | wenig | वेनिष | little | थोड़ा | थोडे | Ich habe wenig Zeit. |
| 66 | groß | ग्रोस | big | बड़ा | मोठे | Das Haus ist groß. |
| 67 | klein | क्लाइन | small | छोटा | लहान | Ein kleiner Hund. |
| 68 | gut | गूट | good | अच्छा | चांगले | Guten Morgen! |
| 69 | schlecht | श्लेष्ट | bad | बुरा | वाईट | Das Wetter ist schlecht. |
| 70 | neu | नॉय | new | नया | नवीन | Mein neues Auto. |
| 71 | alt | आल्ट | old | पुराना | जुने | Eine alte Stadt. |
| 72 | schnell | श्नेल | fast | तेज़ | जलद | Der Zug ist schnell. |
| 73 | langsam | लांगज़ाम | slow | धीमा | हळू | Bitte langsamer! |
| 74 | immer | इमर | always | हमेशा | नेहमी | Ich lerne immer abends. |
| 75 | nie | नी | never | कभी नहीं | कधीही नाही | Ich rauche nie. |
| 76 | oft | ओफ़्ट | often | अक्सर | अनेकदा | Ich gehe oft ins Kino. |
| 77 | mit | मित | with | के साथ | सोबत | Ich komme mit dir. |
| 78 | ohne | ओने | without | बिना | शिवाय | Kaffee ohne Zucker. |
| 79 | für | फ़्यूर | for | के लिए | साठी | Das Geschenk für dich. |
| 80 | von | फ़ोन | from/of | का/से | चे/ची | Das Buch von Ravi. |
| 81 | nach | नाख़ | to/after | को/के बाद | ला/नंतर | Nach Hause. |
| 82 | zu | त्सू | to | को | ला | Zu Hause. |
| 83 | auf | आउफ़ | on | पर | वर | Auf dem Tisch. |
| 84 | unter | उंतर | under | के नीचे | खाली | Unter dem Bett. |
| 85 | über | ऊबर | over/about | ऊपर/के बारे में | वर/बद्दल | Über das Meer. |
| 86 | neben | नेबेन | next to | के पास | शेजारी | Neben der Schule. |
| 87 | zwischen | त्स्विषेन | between | के बीच | दरम्यान | Zwischen den Häusern. |
| 88 | vor | फ़ोर | before/in front | पहले/के सामने | समोर | Vor dem Bahnhof. |
| 89 | hinter | हिंटर | behind | के पीछे | मागे | Hinter dem Haus. |
| 90 | sehr gut | — | very good | बहुत अच्छा | खूप चांगले | Das Essen ist sehr gut. |
| 91 | kein | काइन | no/none | कोई नहीं | नाही | Ich habe kein Auto. |
| 92 | alle | आले | all | सब | सर्व | Alle Kinder. |
| 93 | viele | फ़ीले | many | कई | पुष्कळ | Viele Menschen. |
| 94 | man | मान | one/people | लोग | माणसे | Man spricht Deutsch. |
| 95 | Herr | हेर | Mr | श्री | श्री | Herr Meier |
| 96 | Frau | फ़्राउ | Mrs/woman | श्रीमती/औरत | सौ/स्त्री | Frau Schmidt |
| 97 | Kind | किंट | child | बच्चा | मूल | Das Kind spielt. |
| 98 | Mann | मान | man | आदमी | पुरुष | Ein freundlicher Mann. |
| 99 | Frau | — | woman | स्त्री | बाई | Eine nette Frau. |
| 100 | Leute | लॉयटे | people | लोग | लोक | Viele Leute tanzen. |

## 1C. A1 Skills Checklist (what a student must DO after A1)

- [ ] Introduce myself (name, country, city, languages, job, hobby) — 30–40 seconds
- [ ] Spell my name in German (P-R-I-Y-A)
- [ ] Count to 100, say my phone number and dates
- [ ] Order food and drinks in a restaurant (Ich möchte…, bitte)
- [ ] Ask for directions (Wo ist…? Wie komme ich…?)
- [ ] Buy a ticket (Ein Ticket nach München, bitte)
- [ ] Fill a registration form
- [ ] Write a ~30-word message (birthday invitation)
- [ ] Ask 3 questions with question words
- [ ] Make polite requests (Können Sie bitte…?)

## 1D. A1 Exam Preparation

- Structure: see [Exam Guide](goethe-exam-guide.md) — Hören 20' · Lesen 25' · Schreiben 20' · Sprechen 15', pass 60/100
- After week 12: take [Mock Test A1](mock-test-a1.md) THREE times, one week apart

---

# Course 2 — GERMAN A2 (12 Weeks)

## 2A. A2 Syllabus — Week by Week

| Week | Topic | Grammar | Vocabulary | Exam link |
| --- | --- | --- | --- | --- |
| 1 | **Perfekt (past tense)** | haben/sein + Partizip II; ge- prefix | Daily life (Alltag) | Lesen 2B: e-mails |
| 2 | Perfekt: irregular verbs + sein-verbs | Ich bin gegangen / gefahren | Travel (Reisen) | Hören: past events |
| 3 | Präteritum: sein, haben, modal | Ich war / ich hatte | Office (Büro) | Schreiben: past email |
| 4 | **Modal verbs review + dürfen** | dürfen (permission); modal word order | Hospital (Krankenhaus) | Sprechen: requests |
| 5 | **Reflexive verbs** | sich waschen, sich freuen | Daily routine | Lesen: articles |
| 6 | **Präpositionen: Dativ + Akkusativ** | in/auf/an + two-way prepositions | Bank (Bank) | Lesen 2D: matching |
| 7 | **Nebensätze (dass, weil, wenn)** | SOV subordinate clauses — the Indian advantage | Renting (Wohnung mieten) | Schreiben: reply email |
| 8 | **Konjunktiv II: würde, könnte** | Ich würde gern… | Job interview (Vorstellungsgespräch) | Sprechen: topic card |
| 9 | Imperative + Sie/du forms | Geben Sie mir bitte… | Shopping (Einkaufen) | Hören: instructions |
| 10 | **Letter writing (Brief)** | Liebe/Lieber, formal letter structure | School (Schule) | Schreiben 3A |
| 11 | **Email writing + connectives** | deshalb, trotzdem, dann | Everyday situations | Schreiben 3B |
| 12 | **Full A2 mock test** | Revision of all A2 grammar | All A2 topics | [Mock Test A2](mock-test-a2.md) |

## 2B. A2 Vocabulary — The 100 Words That Unlock A2

### 2B.1 Daily life & routines (15)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| aufstehen | आउफ़श्टेहेन | to get up | उठना | उठणे | Ich stehe um 7 auf. |
| frühstücken | फ़्र्यूश्ट्युकेन | to have breakfast | नाश्ता करना | नाश्ता करणे | Ich frühstücke gern. |
| arbeiten | आर्बाइटेन | to work | काम करना | काम करणे | Ich arbeite in Berlin. |
| einkaufen | आइनकाउफ़ेन | to shop | खरीदारी करना | खरेदी करणे | Wir kaufen ein. |
| kochen | कोख़ेन | to cook | पकाना | शिजवणे | Ich koche abends. |
| aufräumen | आउफ़रॉयमेन | to tidy | साफ़ करना | आवरणे | Ich räume mein Zimmer auf. |
| fernsehen | फ़ेर्नज़ेहेन | to watch TV | टीवी देखना | टीव्ही पाहणे | Wir sehen fern. |
| schlafen | श्लाफ़ेन | to sleep | सोना | झोपणे | Ich schlafe 8 Stunden. |
| der Wecker | डेर वेकर | alarm clock | अलार्म | गजर | Der Wecker klingelt. |
| die Freizeit | डी फ़्राइत्साइट | free time | खाली समय | मोकळा वेळ | Ich habe wenig Freizeit. |
| müde | म्यूडे | tired | थका हुआ | थकलेला | Ich bin müde. |
| beschäftigt | बेशेफ़्टिष्ट | busy | व्यस्त | व्यस्त | Ich bin beschäftigt. |
| das Geld | दास गेल्ट | money | पैसा | पैसे | Ich brauche Geld. |
| die Zeit | डी त्साइट | time | समय | वेळ | Hast du Zeit? |
| das Handy | दास हेंडी | mobile phone | मोबाइल | मोबाइल | Mein Handy ist kaputt. |

### 2B.2 Office & work (15)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| die Firma | डी फ़िरमा | company | कंपनी | कंपनी | Ich arbeite bei einer Firma. |
| das Büro | दास ब्यूरो | office | दफ़्तर | कार्यालय | Das Büro ist im Zentrum. |
| der Kollege | डेर कोलेगे | colleague | सहकर्मी | सहकारी | Meine Kollegen sind nett. |
| der Chef | डेर शेफ़ | boss | मालिक | मालक | Der Chef ist streng. |
| die Besprechung | डी बेश्प्रेख़ुंग | meeting | बैठक | सभा | Die Besprechung ist um 10. |
| der Termin | डेर टेरमीन | appointment | मुलाकात | भेट | Ich habe einen Termin. |
| die Arbeit | डी आर्बाइट | work | काम | काम | Die Arbeit ist schwer. |
| das Projekt | दास प्रोयेक्त | project | परियोजना | प्रकल्प | Das Projekt ist fertig. |
| der Bericht | डेर बेरिष्ट | report | रिपोर्ट | अहवाल | Ich schreibe einen Bericht. |
| die E-Mail | डी ईमेल | email | ईमेल | ईमेल | Ich schicke eine E-Mail. |
| der Computer | डेर कोम्प्यूटर | computer | कंप्यूटर | संगणक | Der Computer ist langsam. |
| das Dokument | दास डोकुमेंट | document | दस्तावेज़ | दस्तऐवज | Bitte das Dokument! |
| die Sprache | डी श्प्राखे | language | भाषा | भाषा | Deutsch ist die Sprache. |
| der Kunde | डेर कुंडे | customer | ग्राहक | ग्राहक | Der Kunde ruft an. |
| verdienen | फ़ेरडीनेन | to earn | कमाना | कमवणे | Ich verdiene gut. |

### 2B.3 Health & hospital (12)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| der Arzt/die Ärztin | डेर आर्ट्स्ट | doctor | डॉक्टर | डॉक्टर | Ich gehe zum Arzt. |
| das Krankenhaus | दास क्रांकेनहाउस | hospital | अस्पताल | रुग्णालय | Das Krankenhaus ist groß. |
| krank | क्रांक | ill | बीमार | आजारी | Ich bin krank. |
| gesund | गेज़ुंत | healthy | स्वस्थ | निरोगी | Bleiben Sie gesund! |
| der Schmerz | डेर श्मेर्त्स | pain | दर्द | वेदना | Ich habe Schmerzen. |
| der Husten | डेर हुस्टेन | cough | खांसी | खोकला | Ich habe Husten. |
| die Tablette | डी टाब्लेटे | tablet | गोली | गोळी | Eine Tablette nehmen. |
| die Medizin | डी मेडित्सीन | medicine | दवा | औषध | Ich brauche Medizin. |
| der Termin beim Arzt | — | doctor's appointment | डॉक्टर की मुलाकात | डॉक्टरांची भेट | Ich brauche einen Termin. |
| wehtun | वेहतून | to hurt | दर्द होना | दुखणे | Mein Kopf tut weh. |
| die Versicherung | डी फ़ेरज़िषेरुंग | insurance | बीमा | विमा | Die Versicherung zahlt. |
| die Krankenkasse | डी क्रांकेनकासे | health insurance | स्वास्थ्य बीमा | आरोग्य विमा | Ich bin bei der AOK. |

### 2B.4 Bank & money (10)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| die Bank | डी बांक | bank | बैंक | बँक | Ich gehe zur Bank. |
| das Konto | दास कोंटो | account | खाता | खाते | Ich habe ein Konto. |
| das Konto eröffnen | — | to open an account | खाता खोलना | खाते उघडणे | Ich möchte ein Konto eröffnen. |
| das Geld abheben | — | to withdraw money | पैसे निकालना | पैसे काढणे | Ich hebe Geld ab. |
| überweisen | ऊबरवाइज़ेन | to transfer | हस्तांतरण | हस्तांतर | Ich überweise 100 Euro. |
| die Überweisung | डी ऊबरवाइज़ुंग | transfer | हस्तांतरण | हस्तांतरण | Die Überweisung ist da. |
| die Karte | डी कार्टे | card | कार्ड | कार्ड | Ich bezahle mit Karte. |
| das Bargeld | दास बारगेल्ट | cash | नकद | रोख | Ich habe kein Bargeld. |
| der Zins | डेर त्सिंस | interest | ब्याज | व्याज | Die Zinsen sind hoch. |
| der Geldautomat | डेर गेल्टआउटोमाट | ATM | एटीएम | एटीएम | Der Geldautomat ist neben der Bank. |

### 2B.5 Renting a flat (10)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| die Wohnung | डी वोनुंग | flat | मकान | घर | Ich suche eine Wohnung. |
| mieten | मीटेन | to rent | किराए पर लेना | भाड्याने घेणे | Ich möchte mieten. |
| der Vermieter | डेर फ़ेरमीटर | landlord | मकान मालिक | घरमालक | Der Vermieter ist freundlich. |
| die Miete | डी मीटे | rent | किराया | भाडे | Die Miete ist 700 Euro. |
| die Kaution | डी काउत्सियोन | deposit | जमानत | ठेव | Die Kaution ist 2 Monatsmieten. |
| die Nebenkosten | डी नेबेनकोस्टेन | extra costs | अतिरिक्त खर्च | अतिरिक्त खर्च | Nebenkosten inklusive. |
| der Mietvertrag | डेर मीटफ़ेरत्राक | lease | किराया अनुबंध | भाडेकरार | Bitte den Mietvertrag! |
| der Umzug | डेर उम्त्सूक | moving | स्थानांतरण | हलवणे | Der Umzug ist am Samstag. |
| die Besichtigung | डी बेज़िष्टिगुंग | viewing | देखना | पाहणे | Die Besichtigung ist um 16 Uhr. |
| die Nachbarn | डी नाख़बार्न | neighbours | पड़ोसी | शेजारी | Die Nachbarn sind ruhig. |

### 2B.6 Job interview (10)

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| das Vorstellungsgespräch | दास फ़ोरश्टेलुंग्सगेश्प्रेख़ | job interview | नौकरी का इंटरव्यू | नोकरीची मुलाखत | Ich habe ein Vorstellungsgespräch. |
| die Stelle | डी श्टेले | position | पद | पद | Die Stelle ist frei. |
| die Bewerbung | डी बेवेरबुंग | application | आवेदन | अर्ज | Meine Bewerbung ist fertig. |
| der Lebenslauf | डेर लेबेन्सलाउफ़ | CV | बायोडाटा | परिचयपत्र | Mein Lebenslauf ist aktuell. |
| die Erfahrung | डी एरफ़ारुंग | experience | अनुभव | अनुभव | Ich habe Erfahrung. |
| die Fähigkeit | डी फ़ेहिष्काइट | skill | कौशल्य | कौशल्य | Meine Fähigkeiten: Deutsch, Englisch. |
| arbeiten bei | — | to work at | काम करना | काम करणे | Ich arbeite bei Siemens. |
| die Aufgabe | डी आउफ़गाबे | task | कार्य | काम | Meine Aufgabe ist… |
| das Team | दास टीम | team | टीम | पथक | Ich arbeite gern im Team. |
| die Ausbildung | डी आउसबिल्डुंग | training/education | प्रशिक्षण | प्रशिक्षण | Meine Ausbildung: Ingenieur. |

### 2B.7 Connectors & sentence words (12) — the A2 superpower

| German | Pronunciation | English | Hindi | Marathi | Example |
| --- | --- | --- | --- | --- | --- |
| deshalb | देसहाल्प | therefore | इसलिए | म्हणून | Ich bin müde, deshalb gehe ich schlafen. |
| trotzdem | त्रोत्सडेम | nevertheless | फिर भी | तरीही | Es regnet, trotzdem gehen wir. |
| dann | दान | then | फिर | मग | Erst lerne ich, dann koche ich. |
| zuerst | त्सूएर्स्ट | first | पहले | आधी | Zuerst das Frühstück. |
| danach | दानाख़ | after that | उसके बाद | नंतर | Danach gehe ich zur Arbeit. |
| vorher | फ़ोरहेर | before | पहले | आधी | Vorher rufe ich an. |
| obwohl | ओबवोल | although | हालाँकि | जरी | Obwohl es spät ist, bleibe ich. |
| weil | वाइल | because | क्योंकि | कारण | Ich bleibe, weil ich Spaß habe. |
| dass | दास | that | कि | की | Ich weiß, dass du kommst. |
| wenn | वेन | if/when | अगर/जब | जर/जेव्हा | Wenn ich Zeit habe, lerne ich. |
| als | आल्स | when (past) | जब | जेव्हा | Als ich klein war… |
| ob | ओप | whether | कि नहीं | का नाही | Ich weiß nicht, ob er kommt. |

## 2C. A2 Skills Checklist

- [ ] Talk about yesterday/weekend (Perfekt: Ich bin gegangen, ich habe gekocht)
- [ ] Describe my daily routine with reflexive verbs
- [ ] Make an appointment by phone (Ich möchte einen Termin…)
- [ ] Go to the bank: open account, withdraw money
- [ ] Visit a doctor and describe symptoms (Ich habe Husten, mein Kopf tut weh)
- [ ] Rent a flat: viewing, contract questions
- [ ] Survive a job interview (describe experience, skills, strengths)
- [ ] Write a ~40-word email AND reply to an email
- [ ] Use deshalb/trotzdem/weil/dass to connect ideas
- [ ] Make polite requests with Könnten Sie bitte…?

## 2D. A2 Exam Preparation

- Structure: see [Exam Guide](goethe-exam-guide.md) — Hören 30' · Lesen 30' · Schreiben 30' · Sprechen 15', pass 60/100
- After week 12: take [Mock Test A2](mock-test-a2.md) THREE times, one week apart

---

## Part 3 — False Friends for Marathi/Hindi Speakers (learn these or get confused!)

| German | Looks/sounds like | Actually means | Correct Hindi/Marathi | Example |
| --- | --- | --- | --- | --- |
| **bekommen** | "become" (बीकम) | **to GET** | पाना / मिळणे | Ich bekomme ein Geschenk. |
| **Gift** | "gift" (गिफ्ट) | **poison** | ज़हर / विष | Das ist kein Geschenk, das ist Gift! |
| **bald** | "bold"? | **soon** | जल्दी / लवकर | Bis bald! |
| **Rat** | "rat" (चूहा) | **advice** | सलाह / सल्ला | Er gibt einen guten Rat. |
| **fast** | "fast" (तेज़) | **almost** | लगभग / जवळपास | Fast fertig! |
| **hell** | "hell" (नरक) | **bright** | उज्ज्वल / तेजस्वी | Das Licht ist hell. |
| **der Gang** | "gang" (गिरोह) | **hallway/gear** | गलियारा / हालचाल | Der Gang ist lang. |
| **das Handy** | "handy" | **mobile phone** | मोबाइल | Mein Handy klingelt. |
| **schwanger** | "swing"? | **pregnant** | गर्भवती | — |
| **die Hochzeit** | "hoch" (high)? | **wedding** | शादी / लग्न | Die Hochzeit ist im Mai. |
| **bekannt** | "became"? | **well-known** | प्रसिद्ध | Er ist bekannt. |
| **der Saft** | "soft"? | **juice** | रस / रस | Orangensaft, bitte! |
| **die Küche** | "kitchen"? — OK same | kitchen | रसोई / स्वयंपाकघर | Die Küche ist klein. |
| **kalt** | "cold" | cold | ठंडा / थंड | Das Wasser ist kalt. |
| **der Strom** | "storm" (तूफ़ान) | **electricity** | बिजली / वीज | Der Strom ist teuer. |
...
| --- | --- | --- | --- |
| 1 | „Ich bin 25 Jahre." | Hindi: मैं 25 साल का हूँ (to be + age) | German uses NO verb here: **Ich bin 25 Jahre alt.** (different from Spanish! — see below) |
| 2 | „Ich habe Hunger." correct, but „ich habe 25 Jahre" WRONG | Mixed up with Hindi "मेरी उम्र है"? | Age: **ich bin … Jahre alt**; hunger: **ich habe Hunger** |
| 3 | „Ich wohne auf Pune." | Hindi: पुणे **में** (mein = in) | Cities: **in Pune** (in + Dativ) |
| 4 | „Ich lerne Deutsch seit zwei Jahre." | No plural case marking in Hindi after postposition | **seit zwei Jahren** (Dativ plural +n!) |
| 5 | „Er kommt von India." | Hindi: भारत **से** | Countries without article: **aus Indien** |
| 6 | „Der Mann, er ist nett." (double subject) | Hindi relative: वह आदमी जो… | German relative: **der Mann, der nett ist** — or simple: Der Mann ist nett |
| 7 | „Ich kann nicht schwimmen" — correct, but „Ich kann nicht kommen morgen" | Hindi: मैं कल नहीं आ सकता (time at end) | German time BEFORE place but verb stays 2nd: **Ich kann morgen nicht kommen** |
| 8 | Saying "ß" as just "s" | No ß in Hindi/Marathi script | ß = long vowel + s: Straße = श्ट्रा(लंबी)से |
| 9 | „das Mädchen" — students say "die Mädchen" | It IS a girl! | **das** Mädchen (grammatical gender ≠ meaning — the -chen suffix makes it neutral!) |
| 10 | „Ich lerne Deutsch, weil ich will in Deutschland arbeiten." | Hindi SOV order applied to main clause | Subordinate clause = SOV: **weil ich in Deutschland arbeiten will.** |

---

## Part 5 — Pronunciation Drills (minimal pairs)

### 5.1 German A1 drills

| Pair | Difference | Drill sentence |
| --- | --- | --- |
| bitte / biete | short i vs long ie | „Ich bitte dich, ich biete Tee an." |
| bieten / beten | ie (ई) vs e (ए) | „Ich biete Hilfe, du betest." |
| Zug / Zoll | ts at start | „Der Zug nach Zürich zahlt Zoll." (10× fast) |
| was / vas | w = व | „Was willst du? Ich will Wasser." |
| ich / ach | soft ch / hard ch | „Ich lache nicht, ich sage ach!" |
| nett / nass | e vs a | „Sie ist nett, aber das Kleid ist nass." |
| Haus / Maus | au diphthong | „Die Maus ist im Haus." |
| fünf / viel | ü (rounded ई) | „Ich habe fünf Bücher, viel Spaß." |
| hören / Herren | ö (rounded ए) | „Ich höre die Herren." |
| schön / schon | ö vs o | „Es ist schon schön." |

**ü/ö/ä technique for Indian students:** say ई (i), then round your lips as if saying ओ (o) — you get ü. Same for ए → ö. आ → ä.

### 5.2 German A2 drill (past forms)

| Present | Perfekt | Drill |
| --- | --- | --- |
| ich gehe | ich bin gegangen | „Ich gehe, ich bin gegangen, ich gehe wieder." |
| ich esse | ich habe gegessen | „Ich esse, ich habe gegessen, ich esse wieder." |
| ich fahre | ich bin gefahren | „Ich fahre, ich bin gefahren, ich fahre wieder." |
| ich sehe | ich habe gesehen | „Ich sehe, ich habe gesehen, ich sehe wieder." |

**Rule for sein vs haben in Perfekt:** movement or change of state → sein (fahren, gehen, fliegen, aufstehen, werden). Everything else → haben. Just like Hindi मैं गया (going = change of location, use गया).
...
### A1 activities
1. **Der-die-das memory game:** 30 noun cards; students sort into 3 boxes; wrong box = 1 point to the class. Repeat weekly with new words.
2. **Name spelling race:** students spell each other's Indian names aloud in German letters (P-R-I-Y-A).
3. **Restaurant role-play:** full order + bill with toy money (Ich möchte…, Das kostet…).
4. **Number dictation:** teacher says „fünf-und-vierzig", students write 45.
5. **Sie/du sorting game:** situations on cards (police officer, friend, grandmother) → student says the right form.

### A2 activities
6. **Weekend storyteller:** each student says 3 things they did (Perfekt), class asks questions (Wann? Wo? Mit wem?).
7. **Phone appointment role-play:** student calls a doctor's office (Ich möchte einen Termin… Ich habe Husten…).
8. **Flat-hunting game:** match landlord ads to tenant cards (Miete, Kaution, Nebenkosten).
9. **Job interview simulation:** 5-minute interview with real questions; class scores answers.
10. **Dass/weil sentence chain:** student A starts „Ich bin müde…", student B continues „…weil ich gestern nicht geschlafen habe."

---

## Part 7 — Indian-Context Bonus Vocabulary (words you will actually need)

### 7.1 Indian food in German (used in German restaurants & supermarkets)

| German | English | Hindi | Marathi |
| --- | --- | --- | --- |
| der Reis | rice | चावल | तांदूळ |
| das Curry | curry | करी | करी |
| die Linsen | lentils | दाल | डाळ |
| der Fladenbrot | flatbread | रोटी | पोळी |
| der Ingwer | ginger | अदरक | आले |
| der Knoblauch | garlic | लहसुन | लसूण |
| der Koriander | coriander | धनिया | कोथिंबीर |
| der Kreuzkümmel | cumin | जीरा | जिरे |
| der Kurkuma | turmeric | हल्दी | हळद |
| scharf | spicy | तीखा | तिखट |
| vegetarisch | vegetarian | शाकाहारी | शाकाहारी |
| halal | halal | हलाल | हलाल |

### 7.2 Family words — the cultural point (German has FEWER words!)

| Hindi/Marathi | German | Meaning |
| --- | --- | --- |
| मावशी / माहेरची आत्या | **die Tante** | aunt (all aunts are Tante!) |
| काकी / चाची / भावजय | **die Tante** | aunt |
| मामा / काका / चाचा / भाऊजी | **der Onkel** | uncle |
| दादी / आजी / नानी | **die Oma** | grandmother |
| दादा / आजोबा / नाना | **der Opa** | grandfather |
| भाऊ / दादा / भाई | **der Bruder** | brother |
| बहीण / बहन | **die Schwester** | sister |

> **Teach this as culture:** Germans say „meine Tante" and everyone understands — you must say which side („die Tante von meiner Mutter" if needed). The German family system is SMALLER — and the exam only needs the basics.

### 7.3 Professions Indians commonly pursue in Germany

| German | English | Hindi | Marathi |
| --- | --- | --- | --- |
| der Ingenieur | engineer | अभियंता | अभियंता |
| der Arzt / die Ärztin | doctor | डॉक्टर | डॉक्टर |
| der Pfleger | nurse/carer | नर्स | परिचारक |
| der Softwareentwickler | software developer | सॉफ़्टवेयर डेवलपर | सॉफ्टवेअर डेव्हलपर |
| der Wissenschaftler | researcher | वैज्ञानिक | शास्त्रज्ञ |
| der Lehrer | teacher | शिक्षक | शिक्षक |
| der Koch | cook | रसोइया | स्वयंपाकी |
| der Fahrer | driver | ड्राइवर | चालक |
| der Student | student | छात्र | विद्यार्थी |
| die Ausbildung | vocational training | प्रशिक्षण | व्यावसायिक प्रशिक्षण |
...
| Day | Activity | Time |
| --- | --- | --- |
| 1 | New vocabulary (10 words) + pronunciation drill | 30 min |
...
| 7 | Rest / optional German movie or song | — |

> **Final exam readiness rule:** students pass Goethe A1 when they score **65+/100** on the mock test twice in a row, and A2 when they score **65+/100** on the A2 mock test twice in a row.
